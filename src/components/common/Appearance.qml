...
QtObject {
    ...
    colors: QtObject {
        property color colPrimary: "#D0BCFF"
        property color colPrimaryContainer: "#4F378B"
        property color colSecondaryContainer: "#534457"
        property color colOnSecondaryContainer: m3colors.m3onSecondaryContainer
        property color colOnPrimary: "#381E72"
        
        property color colLayer0: "#141218"
        property color colLayer1: "#2B2930"
        property color colLayer2: "#36343B"
        property color colLayer1Hover: colLayer2
        
        property color colOnLayer0: "#E6E0E9"
        property color colOnLayer2: "#E6E0E9"
        property color colSubtext: "#CAC4D0" 
        
        property color colErrorContainer: "#8C1D18"
    ...
    sizes: QtObject {
        ...
        property real dashboardWidth: 600
    }
}